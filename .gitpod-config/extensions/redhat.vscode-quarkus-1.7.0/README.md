...
For information on getting started, refer to the [CONTRIBUTING instructions](https://github.com/redhat-developer/vscode-quarkus/blob/master/CONTRIBUTING.md).
...
Apache License 2.0.
See [LICENSE](https://github.com/redhat-developer/vscode-quarkus/blob/master/LICENSE) file.
